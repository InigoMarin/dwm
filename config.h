...
static Key keys[] = {
	...
	{ MODKEY,			XK_Escape,	spawn,	SHCMD("st -e clipmenu") },
	...
	{ MODKEY,			XK_Insert,	spawn,		SHCMD("st -e clipmenu") },
	...
	{ 0, XF86XK_AudioRaiseVolume,	spawn,		SHCMD("amixer -D pulse sset Master 10%+; kill -44 $(pidof dwmblocks)") },
	{ 0, XF86XK_AudioLowerVolume,	spawn,		SHCMD("amixer -D pulse sset Master 10%-; kill -44 $(pidof dwmblocks)") },
