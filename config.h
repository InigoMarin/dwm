...
static const Rule rules[] = {
	...
	*/
	...
	/* Firefox about floating */
    { "firefox",  "Browser",  NULL,       	    0,            1,           0,         0,        -1 },{ "Postman",  NULL,       NULL,       	    1 << 2,       0,           1,         0,         0 },
	{ NULL,"www.gmail.com",   NULL,       	    0 << 1,       0,           1,         0,         0 },
	{ "Spring Tool Suite 4",  NULL,       NULL,       	    1 << 2,       0,           1,         0,         -1 },
...
static Key keys[] = {
	...
	{ MODKEY,			XK_Escape,	spawn,	SHCMD("chromium") },
...
/*	{ MODKEY|ShiftMask,	XK_w,		spawn,		SHCMD("dswitcher") },*/
	...
	{ MODKEY,      		XK_s,		spawn,		SHCMD("dmenu-sr") }, 
	...
	{ MODKEY|ShiftMask,	XK_c,		spawn,		SHCMD("qutebrowser") }, 
    ...
    { MODKEY,			XK_Scroll_Lock,	spawn,	SHCMD("slock & xset dpms force off; mpc pause; pauseallmpv") },
    { MODKEY|ShiftMask,	XK_Scroll_Lock,	spawn,	SHCMD("killall screenkey || screenkey &") },
